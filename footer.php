  ...
  <footer>
    ...
    <div id="footer-container"><!-- Begin the Footer Container -->
      ...
      <div class="g1-footer">
        ...
        <ul class="footer">
        <a href="<?php bloginfo('url'); ?>/faq/"><li><?php global $wp_query; $postid = $wp_query->post->ID; echo get_post_meta($post=124, 'footer_faq', true); ?><span class="icon" id="small">_</span></li></a>
        <a href="<?php bloginfo('url'); ?>/resourcespromote/"><li><?php global $wp_query; $postid = $wp_query->post->ID; echo get_post_meta($post=124, 'footer_resources_promote', true); ?><span class="icon" id="small">?</span></li></a>
        <a href="<?php bloginfo('url'); ?>/schedule/"><li><?php global $wp_query; $postid = $wp_query->post->ID; echo get_post_meta($post=124, 'footer_schedule', true); ?><span class="icon" id="small">P</span></li></a>
